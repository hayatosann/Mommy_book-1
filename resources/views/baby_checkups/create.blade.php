...
<li>歯・口腔の疾病異常: <span><input type="text" name="oral_disease"></span></li>
<li>生え変わり:  <span><input type="number" name="replaced_teeth"></span> 本</li>
<li>健康・要観察:
    <span>
...
<li>指導事項: <span><input type="textarea" name="guidance"></span></li>
<li>施設名/担当者名: <span><input type="text" name="supervisor_name"></span></li>
@endsection
