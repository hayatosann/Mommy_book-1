...
Route::get('maternity_checkup/{id}/edit', 'Maternity_checkupController@edit')->name('maternity_checkups.edit'); // 編集画面
Route::put('maternity_checkup/{id}/update', 'Maternity_checkup@update')->name('maternity_checkups.update'); //更新処理